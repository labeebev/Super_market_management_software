...
ResultSet Rs = null;
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\LEV\\Downloads\\PROJECT\\ICON.png")); // NOI18N

        jLabel6.setFont(new java.awt.Font("Consolas", 1, 22)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("CITY SUPERMARKET");
        ...
        RoleCb.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\LEV\\Downloads\\PROJECT\\free-user-login-icon-305-thumb.png")); // NOI18N
        jLabel5.setMaximumSize(new java.awt.Dimension(57, 47));
    ...
    private void LoginBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_LoginBtnMouseClicked
        ...
        String Query = "select * from LEV.SELLERTB where SELLERNAME='"+uid.getText()+"' and SELLERPASSWORD='"+password.getText()+"'";
        try {
        ...
        if(Rs.next()){
            ...
            String Query = "select * from LEV.ADMINTB where ADMINNAME='"+uid.getText()+"' and ADMINPASS='"+password.getText()+"'";
        try {
            Con = DriverManager.getConnection("jdbc:derby://localhost:1527/Supermarket","lev","pass");
        St = Con.createStatement();
        Rs = St.executeQuery(Query);
